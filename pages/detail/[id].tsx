        ...
        <div className="flex w-full absolute left-0 top-0 bg-white flex-wrap lg:flex-nowrap">
            ...
            <div className="relative w-[1000px] md:w-[900px] lg:w-[700px]">
                <div className="lg:mt-20 mt-10">
                    <div className="ml-5 flex gap-3 p-2 cursor-pointer font-semibold rounded">
                    ...
                    <p className="ml-5 mt-5 px-3 text-lg text-gray-600">{post.caption}</p>
                    <div className="ml-5 mt-10 mb-3 px-3">
                        {userProfile && (
                            <LikeButton
                                likes={post.likes}
